    ...
    <div className="competences-container">
      ...
      <div className="right-section">
        ...
        <div className="exp-container">
          <h1 className="titreComp">Experiences</h1>
          {experiences.map((item, index) => (
            <div className="BoxExp" key={index}>
              <div className="PartySociete">
                ...
                <a href={item.link} ><p className="LinkSociete">Link societe</p></a> <br />
              </div>
      ...
      <ul className="align">
        <li>
          <figure className='book'>
            ...
            <ul className='page'>
              <li></li>
              <li><a className="btn "href="./Meher-Resume.pdf" download="Meher-Resume.pdf">Download</a></li>
              <li></li><li></li><li></li>
            </ul>
